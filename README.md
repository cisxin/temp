...
## samba rsync
  ...
  //rsync
    ...
    sudo rsync -av --progress elk/ nfsshare/elk153
...
## llm
  ...
  //ollama
    ...
    curl http://10.23.0.111:11434/api/generate -d '{"model": "qwen3.6","prompt": "你是谁?","stream": false}'
...
## iis [java .keystore] elk
  ...
  //proxy
    ...
    pip3 install pysocks httpx[socks]
...
LTRIM q_day_minute:SZ520146:20260806 0 255